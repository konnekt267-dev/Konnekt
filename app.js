...
function renderAccountArea(){
  ...
  if(session){
    ...
    area.innerHTML = `
      <button class="notification-button" onclick="openNotifications()" aria-label="Notifications"><img src="bell_greyscale.png" class="notifications-img" alt="Notifications" width="25" height="25"><span class="nav-badge notification-badge" id="notificationBadge" style="display:none;"></span></button>

    ...
    return `
      <div class="field full">
        ...
        <div class="location-row">
          <input type="text" id="wLocation" value="${escapeHtml(wizard.location_text)}" placeholder="e.g. Charlotte, NC">
          <button type="button" class="btn btn-ghost btn-small" id="wLocationBtn" onclick="useMyLocation('wLocationBtn')">📍 Share my location</button>
        </div>

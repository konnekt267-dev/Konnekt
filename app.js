...
function renderAccountArea(){
  ...
  if(session){
    ...
    area.innerHTML = `
      <button class="notification-button" onclick="openNotifications()" aria-label="Notifications"><img src="bell_greyscale.png" alt="Notifications" width="38" height="38"><span class="nav-badge notification-badge" id="notificationBadge" style="display:none;"></span></button>

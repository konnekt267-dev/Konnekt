...
function renderAccountArea(){
  ...
  if(session){
    ...
    area.innerHTML = `
      <button class="notification-button" onclick="openNotifications()" aria-label="Notifications"><img src="images/bell_greyscale.png" class="notifications-img" alt="Notifications" width="21" height="24"><span class="nav-badge notification-badge" id="notificationBadge" style="display:none;"></span></button>
    ...
    body.innerHTML = `
      <div class="profile-public-hero">
        ...
        <div class="profile-public-main">
          ...
          <div class="profile-header-trust">
            <span class="profile-header-trust-stars">${starDisplay(trust.avg || 0)}</span>
            <span class="profile-header-trust-rating">${trust.avg != null ? trust.avg.toFixed(1) : '0.0'}</span>
            <span class="profile-header-trust-sep">·</span>
            <span class="profile-header-trust-deals">${trust.completedCount} completed deal${trust.completedCount===1?'':'s'}</span>
          </div>
      ...
      <div class="profile-social-stats profile-social-stats-grid public"><span><strong>${community.followers}</strong>Followers</span><span><strong>${community.following}</strong>Following</span><span><strong>${community.posts.length}</strong>Updates</span></div>

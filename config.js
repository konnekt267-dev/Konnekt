window.KONNEKT_CONFIG = {
  ...
  // Free key from https://www.geoapify.com/ (Freemium tier: 3,000 requests/day).
  // Powers the address autocomplete + "share my location" lookup on the signup page.
  // Leave as-is to fall back to plain text entry with no autocomplete.
  GEOAPIFY_API_KEY: ""
};
